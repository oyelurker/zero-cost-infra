...
JSON
{
  "ANTHROPIC_BASE_URL": "[https://cc.freemodel.dev](https://cc.freemodel.dev)",
...
Bash
npm install -g @anthropic-ai/claude-code
3/ run the command claude once to auto-generate the directory, then close the terminal.

4/ open your config file. it lives at C:\Users\<your-username>\.claude\settings.json.
